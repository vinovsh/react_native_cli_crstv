...
const LeaderBoard = props => {
  ...
  const getdata = async () => {
    try {
      await axios
        .post(config.BASE_URL + 'leader_board_list?page=' + currentPage, {
          token: token,
        })
              ...
              <View style={styles.leader_card}>
                ...
                <View style={styles.infobox}>
                  ...
                  <View style={styles.div2}>
                    ...
                    <Text
                      numberOfLines={1}
                      style={{color: '#fff', fontSize: 15, margin: 2}}>
                      {apidata.users.data[0].name}
                    </Text>
                  </View>
